package TestCOT.SchoolAdminRole.Homework;
...
public class GoToApp {
    ...
    @Test
    public void testGoToApp() throws Exception {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("HOMEWORK ASSIGNMENTS")));
    }
