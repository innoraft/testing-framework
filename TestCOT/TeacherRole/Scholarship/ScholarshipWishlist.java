...
public class ScholarshipWishlist {
    ...
    public void testScholarshipWishlist() throws Exception {
        ...
        driver.findElement(By.linkText("Scholarship Wish List")).click();
        driver.findElement(By.cssSelector("a.college-wishlist-flag-link-116411.remove-scholarship-wishlist-link")).click();
        driver.findElement(By.cssSelector("a.chzn-single.chzn-single-with-drop > span")).click();
        driver.findElement(By.cssSelector("a.college-wishlist-flag-link-168251.remove-scholarship-wishlist-link")).click();
    }
