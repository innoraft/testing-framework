...
public class GoToScholarshipApp {
    COTFunctions func;
    ...
    @Test
    public void testGoToScholarshipApp() throws Exception {
        // Click Home
        driver.findElement(By.xpath("//div[@id='nav-group-home']")).click();
        // Click Scholarship
        driver.findElement(By.linkText("Scholarships")).click();
        // Wait for page to load.
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("SCHOLARSHIP WISH LIST")));
    }
