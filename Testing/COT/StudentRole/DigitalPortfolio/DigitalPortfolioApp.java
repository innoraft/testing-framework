...
public class DigitalPortfolioApp {
    COTFunctions func;
    ...
    @Test
    public void testDigitalPortfolioApp() throws Exception {
        // Click Home
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("JOURNAL")));
    }
