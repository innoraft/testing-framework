...
public class CreateSurvey {
    ...
    public void testCreateSurvey() throws Exception {
        ...
        driver.findElement(By.xpath("//*[@id=\"edit_field_admin_survey_und_chzn_o_1\"]")).click();
        // Select Group
        driver.findElement(By.xpath("//div[3]/div/div/a/span")).click();
        driver.findElement(By.xpath("//*[@id=\"edit_field_survey_options_und_chzn_o_2\"]")).click();
        // Wait For Grade Select List To Load
        Thread.sleep(2000);
        // Select Grade
        driver.findElement(By.xpath("//div[4]/div/div/a/span")).click();
        driver.findElement(By.xpath("//*[@id=\"edit_field_survey_grades_und_chzn_o_5\"]")).click();
        // Click Save Button
