...
public class GoToDashboardApp {
    ...
    @Test
    public void testGoToDashboardApp() throws Exception {
        // Click Home
        driver.findElement(By.xpath("//div[@id='nav-group-home']")).click();
        // Click Dashboard
        driver.findElement(By.linkText("Dashboard")).click();
        // Wait for page to load
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("REPORTS")));
    }
