...
public class Brochure extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"dummy", "Today", "ShortDesc", "Desc", FilesPath + "bc.pdf", "dummy@gmail.com", FilesPath + "abc.jpg", "alternate", "PicTitle", "metaDesc", "metaKey", "all inputs are correct"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public Brochure(String Title, String Date, String ShortDescription, String Body, String DownloadPDF, String MapTo, String ResourceImage, String AlternateText, String PictureTitle, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Date = Date;
