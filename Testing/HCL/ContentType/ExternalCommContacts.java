...
public class ExternalCommContacts extends HCLAbstract {
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public ExternalCommContacts(String Title, String Body, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Body = Body;
    ...
    public void CreateContent() throws Exception {
        try {
            ...
            driver.get(baseUrl + "/node/add/external-communication-contacts");
            // Enter Title
    ...
    public void UpdateContent() throws Exception {
        try {
            // Click edit link of that content which type is External Communication Contacts
            ...
            for (int i = 0; i < Types.size(); i++) {
                ...
                if (ContentType.equals("External Communication Contacts")) {
                    RowNumber = i + 1;
