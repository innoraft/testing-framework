...
public class FrontLinkedSlideshow extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"Title", "Body", FilesPath + "abc.jpg", "AltText", "PicTitle", "http://google.com/", "MetaDesc", "MetaKey", "All inputs are correct"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public FrontLinkedSlideshow(String Title, String Body, String FrontSlideshowImage, String AlternateText, String PictureTitle, String FrontSlideShowLink, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Body = Body;
