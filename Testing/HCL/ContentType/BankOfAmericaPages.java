...
public class BankOfAmericaPages extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"title", "body", FilesPath + "abc.jpg", "AltText", "PicTitle", "metaDesc", "metaKey", "all inputs are correct"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public BankOfAmericaPages(String Title, String Body, String BannerImage, String  AlternateText, String PictureTitle, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Body = Body;
    ...
    public void CreateContent() throws Exception {
        try {
            // Move to Bank Of America Page
            driver.get(baseUrl + "/node/add/bankofamerica-pages");
            // Enter Title
    ...
    public void UpdateContent() throws Exception {
        try {
            // Click edit link of that content which type is Bank Of America Page
            ...
            for (int i = 0; i < Types.size(); i++) {
                ...
                if (ContentType.equals("Bank of america pages")) {
                    RowNumber = i + 1;
