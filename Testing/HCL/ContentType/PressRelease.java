...
public class PressRelease extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"dummy", "Today", "Abstract", "shortDesc", "Desc", FilesPath + "bc.pdf", "metaDesc", "metaKey", "all inputs are correct"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public PressRelease(String Title, String Date, String Abstract, String ShortDescription, String Description, String PDF, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Date = Date;
    ...
    public void CreateContent() throws Exception {
        try {
            ...
            driver.get(baseUrl + "/node/add/press-release");
            // Enter Title
            ...
            driver.findElement(By.xpath("//div[contains(@class, 'field-name-field-published-date')]//input")).sendKeys("Jan 23 2015");
            // Enter Abstract
            driver.findElement(By.xpath("//div[contains(@class, 'field-name-field-abstract')]//span[contains(@class, 'cke_button__source_label')]")).click();
            driver.findElement(By.xpath("//div[contains(@class, 'field-name-field-abstract')]//textarea[contains(@class, 'cke_editable_themed')]")).clear();
            driver.findElement(By.xpath("//div[contains(@class, 'field-name-field-abstract')]//textarea[contains(@class, 'cke_editable_themed')]")).sendKeys(Abstract);
    ...
    public void UpdateContent() throws Exception {
        try {
            // Click edit link of that content which type is Press Release
            ...
            for (int i = 0; i < Types.size(); i++) {
                ...
                if (ContentType.equals("Press Release")) {
                    RowNumber = i + 1;
