...
public class CustomerTestimonials extends HCLAbstract {
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public CustomerTestimonials(String Title, String Body, String MetatagDescription, String MetatagKeyword, String TestCase) {
        this.Title = Title;
        this.Body = Body;
    ...
    public void CreateContent() throws Exception {
        try {
            // Move to Customer Testimonials page
            driver.get(baseUrl + "/node/add/customer-testimonials");
            // Enter Title
            ...
            // Select Pages
            func2.SelectRandomSelectListOption("//div[contains(@class, 'field-name-field-select-pages')]//select");
    ...
    public void UpdateContent() throws Exception {
        try {
            // Click edit link of that content which type is Customer Testimonials
            ...
            for (int i = 0; i < Types.size(); i++) {
                ...
                if (ContentType.equals("Customer Testimonials")) {
                    RowNumber = i + 1;
