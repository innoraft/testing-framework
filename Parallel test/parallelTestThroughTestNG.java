/**
 *Annotation parameter with variable “browser”, "version" and "platform" will receive the  *value passed from xml file. Check the values and then test will perform according to  *these values.
 */
